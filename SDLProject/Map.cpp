...
//  SDLProject
//
//  Created by Emily Yu on 6/30/20.
...
// penetration_x/y prevent from falling through, like the platform class
bool Map::IsSolid(glm::vec3 position, float *penetration_x, float *penetration_y) {
    ...
    *penetration_y = 0;
    ...
    // calculation for penetration prevention
